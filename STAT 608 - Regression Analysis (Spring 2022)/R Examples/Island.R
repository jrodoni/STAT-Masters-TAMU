islandsum<-read.csv("Island.csv", header=TRUE)
...
par(cex.axis=1.5,cex.lab=1.5, mar=c(5.1,5.1,2,2),lwd=2)
...
#Jittered Plot of log Area By Indicator of Extinct

xx<-seq(-2.5,5,0.01)
yy<-1/(1 + exp(-1*(logm$coeff[1] + logm$coeff[2]*xx)))
par(cex.axis=1.5,cex.lab=1.5, mar=c(5.1,5.1,2,2))
...
par(cex.axis=1.5,cex.lab=1.5, mar=c(5,5,2,2),lwd=2, pch=19)
